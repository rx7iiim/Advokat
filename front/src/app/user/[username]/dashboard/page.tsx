                ...
                {datamok.map((client, index) => (
                  ...
                  >
                    ...
                    <li className="flex justify-around">
                      <span className="mr-5 text-xl font-normal text-gray-800">Casses won </span>
                      <span className="ml-5 font-normal text-gray-500">10</span>
                    </li>
                    <li className="flex justify-around ">
                      <span className="mr-5 mt-5 text-xl font-normal text-gray-800">Casses lost </span>
                      <span className=" ml-5 font-normal mt-5 text-gray-500">0</span>
                    </li>
                  </ul>
