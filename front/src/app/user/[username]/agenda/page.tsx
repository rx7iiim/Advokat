...
const Agenda: React.FC<PageProps> = ({ params }) =>  {
...
>
  Days
        ...
        <button className=" absolute  right-16 px-2 py-3 rounded-md text-lg font-semibold transition-all bg-[linear-gradient(135deg,#0048ff,#00d4ff)] text-white p-3"><div className="flex items-center justify-center">add event <img src="/plus-circle.png" alt="add event"className="w-6 h-6 ml-2" /></div></button>
      </div>
