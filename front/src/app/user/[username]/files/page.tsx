    ...
    <section className="container px-4 mx-auto bg-white">
      <div className="sm:flex sm:items-center sm:justify-between">
        ...
        <div className="flex items-center mt-4 gap-x-3">
          <button className="w-1/2 px-5 py-2 text-sm text-blue-600 transition-colors duration-200 bg-gray-100 border rounded-lg sm:w-auto hover:bg-gray-200" onClick={handleDownloadAll}>
            Download all
          </button>
