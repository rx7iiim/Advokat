...
function HomePage(props: Props) {
 ...
 const deleteclient = async (id: string) => {
    ...
    <div className="flex flex-row overflow-hidden min-h-screen bg-gray-100 text-gray-800 p-2">
      ...
      <main className="flex-1 p-2 overflow-y-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-0 bg-white">
          <div className="bg-white col-span-2 justify-center flex flex-col items-center text-start overflow-hidden">
          <h1 className="text-xl ml-10 font-semibold mb-6 mr-auto">Recently viewed files</h1>
  ...
  >
    ...
    <h5 className="mb-2 text-xl font-bold tracking-tight text-gray-900 font-mona">
      {client.fullName}
    </h5>
    ...
    <div className="flex flex-col justify-around h-2/5 w-full">
      <div className="flex flex-row justify-center gap-[15px] w-full">
        ...
        <div className="w-3/4 overflow-hidden">
          <p className="font-mona w-5/6 text-gray-100 text-xs dark:text-gray-400">
            {client.phoneNumber}
          </p>
        </div>
      </div>
      ...
      <div className="flex flex-row justify-center gap-[15px] w-full">
        ...
        />
        <div className="w-3/4 overflow-hidden">
          <p className="mb-2 font-mona w-5/6 text-gray-100 text-xs dark:text-gray-400">
            {client.email}
          </p>
        </div>
      </div>
          ...
          <div className=" bg-white shadow-md rounded-xl pt-1 pr-3 overflow-hidden bg-gray-200 h-screen flex flex-col items-center">
