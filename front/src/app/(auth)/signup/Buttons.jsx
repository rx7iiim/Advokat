...
function Buttons({step, onPrev, onNext}) {
  return (
    <div className={`flex w-[90vw] m-auto ${
        step === 3 ? 'justify-start' : 'flex-row-reverse justify-between'
      }`}>
     {step < 3 && <button onClick={onNext} className='w-auto border-2 border-solid border-[#0000ff] py-2 px-4 text-[#0000ff] rounded-xl font-bold'>Next</button> }
